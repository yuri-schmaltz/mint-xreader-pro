...
static const GOptionEntry goption_options[] = {
    ...
    {"fullscreen", 'f', 0, G_OPTION_ARG_NONE, &fullscreen_mode,
     N_("Run xreader in fullscreen mode"), NULL},
    ...
    {"presentation", 's', 0, G_OPTION_ARG_NONE, &presentation_mode,
     N_("Run xreader in presentation mode"), NULL},
    {"preview", 'w', 0, G_OPTION_ARG_NONE, &preview_mode,
     N_("Run xreader as a previewer"), NULL},
...
int main(int argc, char *argv[]) {
  ...
  /* Initialize the ATK/AT-SPI bridge for accessibility explicitly *after* GTK
   * init */
  if (!atk_get_root()) {

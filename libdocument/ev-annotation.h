...
#define EV_ANNOTATION_FREE_TEXT(object)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION_FREE_TEXT,          \
                              EvAnnotationFreeText))
#define EV_ANNOTATION_FREE_TEXT_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION_FREE_TEXT,              \
                           EvAnnotationFreeTextClass))
#define EV_IS_ANNOTATION_FREE_TEXT(object)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION_FREE_TEXT))
#define EV_IS_ANNOTATION_FREE_TEXT_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION_FREE_TEXT))
#define EV_ANNOTATION_FREE_TEXT_GET_CLASS(object)                              \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION_FREE_TEXT,           \
                             EvAnnotationFreeTextClass))

/* EvAnnotationInk */
#define EV_TYPE_ANNOTATION_INK (ev_annotation_ink_get_type())
#define EV_ANNOTATION_INK(object)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION_INK,                \
                              EvAnnotationInk))
#define EV_ANNOTATION_INK_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION_INK,                    \
                           EvAnnotationInkClass))
#define EV_IS_ANNOTATION_INK(object)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION_INK))
#define EV_IS_ANNOTATION_INK_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION_INK))
#define EV_ANNOTATION_INK_GET_CLASS(object)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION_INK,                 \
                             EvAnnotationInkClass))
...
#define EV_ANNOTATION_TEXT_MARKUP(object)                                      \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION_TEXT_MARKUP,        \
                              EvAnnotationTextMarkup))
#define EV_ANNOTATION_TEXT_MARKUP_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION_TEXT_MARKUP,            \
                           EvAnnotationTextMarkupClass))
#define EV_IS_ANNOTATION_TEXT_MARKUP(object)                                   \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION_TEXT_MARKUP))
#define EV_IS_ANNOTATION_TEXT_MARKUP_CLASS(klass)                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION_TEXT_MARKUP))
#define EV_ANNOTATION_TEXT_MARKUP_GET_CLASS(object)                            \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION_TEXT_MARKUP,         \
                             EvAnnotationTextMarkupClass))
